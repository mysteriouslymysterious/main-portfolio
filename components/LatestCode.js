...
export default function LatestCode({ repositories }) {
  ...
  return (
    <section className="bg-[#e5ffff] -mt-40 dark:bg-gray-900 pb-40">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center md:pt-40 mx-10">
          <h1 className="text-6xl lg:text-9xl max-w-lg font-bold text-gray-500 my-20 md:my-0 md:text-purple-500 dark:text-gray-500 text-center lg:text-left">
            Latest Code
          </h1>
